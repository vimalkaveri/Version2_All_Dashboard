  ...
  return (
    <Container fluid>
      <Row className="gx-2 gy-4">
        ...
        <Col md={3} className="gx-2 gy-4 d-flex justify-content-center">
          <Card
            style={{
              display: "flex",
          ...
          >
            ...
            <Card.Body
              style={{
                padding: "10px", // Slightly increase padding for better spacing
                display: "flex",
                flexDirection: "column",
                justifyContent: "center",
                alignItems: "center", // Centers content horizontally
                textAlign: "left", // Aligns text inside each span to the left
                height: "100%",
              }}
            >
              <span
                style={{
                  ...
                  textAlign: "left",
                  width: "100%",
                  display: "flex", // Use flexbox for the span
                  justifyContent: "space-between", // Ensures left-alignment of the label and centering of the value
                }}
              >
                <div>Balance:</div>
              ...
              <span
                style={{
                  ...
                  width: "100%",
                  display: "flex", // Use flexbox for the span
                  justifyContent: "space-between", // Aligns label and centers the value
                }}
              >
                <div>Expire on:</div>
                <div style={{ textAlign: "center", flex: 1 }}>
